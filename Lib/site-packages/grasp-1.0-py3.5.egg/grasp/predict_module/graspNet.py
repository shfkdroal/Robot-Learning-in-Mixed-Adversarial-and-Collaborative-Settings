...
class model:
    ...
    def initial_weights(self, weight_file='./models/weights/bvlc_alexnet.npy'):
        ...
        self.conv1W = tf.Variable(conv1W_init, trainable=True)
        self.conv1b = tf.Variable(conv1b_init, trainable=True)
        self.conv2W = tf.Variable(conv2W_init, trainable=True)
        self.conv2b = tf.Variable(conv2b_init, trainable=True)
        self.conv3W = tf.Variable(conv3W_init,trainable=True)
        self.conv3b = tf.Variable(conv3b_init,trainable=True)
        self.conv4W = tf.Variable(conv4W_init,trainable=True)
        self.conv4b = tf.Variable(conv4b_init,trainable=True)
        self.conv5W = tf.Variable(conv5W_init,trainable=True)
        self.conv5b = tf.Variable(conv5b_init,trainable=True)
    ...
    # use reward to generate pseudo label
